...
protected:
    ...
    SmallVectorBase(void *first_el, size_t capacity_)
        : beginx_(first_el), capacity_(capacity_) {}

    void GrowPod(void *first_el, size_t Mincapacity_, size_t Tsize_);
...
template <class T, typename = void> struct SmallVectorAlignmentAndsize_ {
    ...
    AlignedCharArrayUnion<T> first_el;
};
...
class SmallVectorTemplateCommon : public SmallVectorBase {
    void *get_first_el() const {
      return const_cast<void *>(reinterpret_cast<const void *>(
          ...
          offsetof(SmallVectorAlignmentAndsize_<T>, first_el)));
    }

protected:
    SmallVectorTemplateCommon(size_t size_)
        : SmallVectorBase(get_first_el(), size_) {}

    void GrowPod(size_t Mincapacity_, size_t Tsize_) {
        SmallVectorBase::GrowPod(get_first_el(), Mincapacity_, Tsize_);
    }

    bool IsSmall() const { return beginx_ == get_first_el(); }

    void ResetToSmall() {
        beginx_ = get_first_el();
